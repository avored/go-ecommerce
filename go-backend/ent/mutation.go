...
// SetIdentifier sets the "identifier" field.
func (m *PermissionMutation) SetIdentifier(s string) {
	m.identifier = &s
}

// Identifier returns the value of the "identifier" field in the mutation.
func (m *PermissionMutation) Identifier() (r string, exists bool) {
	v := m.identifier
	if v == nil {
		return
	}
...
// OldIdentifier returns the old "identifier" field's value of the Permission entity.
// If the Permission object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PermissionMutation) OldIdentifier(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIdentifier is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetIdentifier resets all changes to the "identifier" field.
func (m *PermissionMutation) ResetIdentifier() {
	m.identifier = nil
}
...
func (m *PermissionMutation) Fields() []string {
	...
	if m.identifier != nil {
		fields = append(fields, permission.FieldIdentifier)
	}
...
// SetIdentifier sets the "identifier" field.
func (m *RoleMutation) SetIdentifier(s string) {
	m.identifier = &s
}

// Identifier returns the value of the "identifier" field in the mutation.
func (m *RoleMutation) Identifier() (r string, exists bool) {
	v := m.identifier
	if v == nil {
		return
	}
...
// OldIdentifier returns the old "identifier" field's value of the Role entity.
// If the Role object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RoleMutation) OldIdentifier(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldIdentifier is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetIdentifier resets all changes to the "identifier" field.
func (m *RoleMutation) ResetIdentifier() {
	m.identifier = nil
}
...
func (m *RoleMutation) Fields() []string {
	...
	if m.identifier != nil {
		fields = append(fields, role.FieldIdentifier)
	}
	if m.description != nil {
