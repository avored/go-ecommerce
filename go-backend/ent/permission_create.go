...
func (pc *PermissionCreate) SetIdentifier(s string) *PermissionCreate {
...
func (pc *PermissionCreate) check() error {
	...
	if _, ok := pc.mutation.Identifier(); !ok {
		return &ValidationError{Name: "identifier", err: errors.New(`ent: missing required field "Permission.identifier"`)}
	}
